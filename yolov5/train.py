...
def train(hyp, opt, device, callbacks):
    ...
    last, best = w / "last.pt", w / "bestfiremodel.pt"
...
def parse_opt(known=False):
    ...
    parser.add_argument("--weights", type=str, default="D:\\yolov5_fire_smoke\yolov5\\weights\\yolov5s.pt", help="initial weights path")
    parser.add_argument("--cfg", type=str, default="D:\\yolov5_fire_smoke\\yolov5\\models\\yolov5s.yaml", help="model.yaml path")
    parser.add_argument("--data", type=str, default=ROOT / "D:\\yolov5_fire_smoke\\yolov5\\data\\fire.yaml", help="dataset.yaml path")
